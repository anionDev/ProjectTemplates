...
class release_creator:
    ...
    def create_release(self):
        ...
        current_branch=self.sc.git_get_current_branch_name(self.repository_folder)
        self.sc.start_program_synchronously("SCCreateSimpleMergeWithoutRelease",f"{self.repository_folder} {current_branch} main projects.aniondev",self.repository_folder,verbosity=2,throw_exception_if_exitcode_is_not_zero=True,prevent_using_epew=True)
