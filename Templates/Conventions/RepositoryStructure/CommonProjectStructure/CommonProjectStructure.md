...
- A runtime-dependency-list and a development-dependency-list for all codeunits
- Applied repository-structure
- Applied branching-system
- Information if conribution is allowed/desired and, if yes, which constraints/conventions/conditions are associated with it
...
The name of a codeunit must be in [Pascal-case](https://www.theserverside.com/definition/Pascal-case).
